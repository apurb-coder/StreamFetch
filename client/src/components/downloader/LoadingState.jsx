  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 space-y-6" id="state-loading">
      <div className="relative h-16 w-16">
        ...
        <div className="absolute inset-0 border-4 border-t-gradient-end rounded-full animate-spin"></div>
      </div>
      ...
      <div className="w-full max-w-sm bg-canvas-dark border border-hairline rounded-full h-2.5 overflow-hidden">
        <div 
          className="bg-gradient-to-r from-gradient-end to-secondary-container h-full transition-all duration-300"
