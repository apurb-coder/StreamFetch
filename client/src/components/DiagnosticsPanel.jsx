...
export default function DiagnosticsPanel({
  ...
  return (
    <section className="max-w-3xl mx-auto px-gutter pb-16">
      <div className="bg-surface border border-hairline rounded-xl p-5 shadow-none transition-all">
        <div 
          onClick={() => {
            const next = !showDiag;
            setShowDiag(next);
          ...
          <div className="mt-5 pt-4 border-t border-hairline space-y-4 animate-fade-in">
            <div className="flex flex-wrap items-center gap-3">
              <div className="flex flex-col space-y-1">
                ...
                <input 
                  ...
                  className="bg-canvas-dark border border-hairline rounded-md px-3 py-1.5 text-xs text-on-surface focus:outline-none focus:border-primary w-64 font-mono"
                />
              </div>
              ...
              <div className="flex flex-col space-y-1">
                ...
                <input 
                  ...
                  className="bg-canvas-dark border border-hairline rounded-md px-3 py-1.5 text-xs text-on-surface focus:outline-none focus:border-primary w-44 font-mono"
                />
              </div>

              <button 
                onClick={fetchDiagnostics}
                className="self-end px-4 py-2 bg-surface-container-highest hover:bg-surface-variant text-on-surface font-bold text-xs rounded-md transition-colors cursor-pointer border-0"
              >
                Refresh Telemetry
              </button>
            </div>
            ...
            {diagnostics ? (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2">
                <div className="bg-canvas-dark border border-hairline p-3 rounded-md">
              ...
              <div className="p-3 bg-error-container/10 border border-error/20 rounded-md text-error font-mono text-xs">
