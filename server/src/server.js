/**
 * Single-Process Express REST API - Server Entrypoint
 * 
 * Sets up the primary web application instance. It includes:
 *  - BullMQ Background Worker: Processes queued YouTube extraction tasks asynchronously
...
app.use(helmet({
  contentSecurityPolicy: true, // Bypass if hosting simple swagger/dashboards
